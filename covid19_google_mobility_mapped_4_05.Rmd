...
## Map and data setup
Data table of percent change visits extracted from [Google Community Mobility Report](https://www.google.com/covid19/mobility/), based on data from **4/5/2020**.
...
# Load data
odf <- read.csv("./data/state_mobility_google_map_20200405.csv")
...
* Data table of actual values plotted. These values were pulled from https://www.google.com/covid19/mobility/ based on data from 4/5/2020.

```{r datatable}
df %>%
  DT::datatable( caption = "Google Community Mobility Data - 4/5/2020") 
```
