...
## 1. Reduced density compared to Jan3-Feb6 in these places: 
...
### % change from Mar.29  to baseline (median of Jan 3-Feb) in visits to Retail/Grocery/Tranist/Workplaces
...
## 2. Increased in density in Residential areas

* All states showed increased density in residential compared to Jan3-Feb6.

### % change from Mar.29  to baseline (median of Jan 3-Feb) in visits to Residential areas
...
### % change from Mar.29  to baseline (median of Jan 3-Feb) in visits to Parks
