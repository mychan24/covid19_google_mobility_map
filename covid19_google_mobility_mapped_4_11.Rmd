...
## Map and data setup
Data table of percent change visits extracted from [Google Community Mobility Report](https://www.google.com/covid19/mobility/), based on data from **4/11/2020**.
...
* Data table of actual values plotted. These values were pulled from https://www.google.com/covid19/mobility/ based on data from 4/11/2020.
